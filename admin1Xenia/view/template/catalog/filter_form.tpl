            ...
            <thead>
              <tr>
                ...
                <td class="text-right"><?php echo $entry_sort_order; ?></td>
                 <td class="text-right"><?php echo $entry_ex; ?></td>
                <td></td>
              </tr>
            </thead>
            <tbody>
              ...
              <tr id="filter-row<?php echo $filter_row; ?>">
                ...
                <td class="text-right" ><input type="text"  name="filter[<?php echo $filter_row; ?>][ex]" value="<?php echo $filter['ex']; ?>" placeholder="<?php echo $entry_ex; ?>" id="input-sort-order" class="form-control" /></td>
...
function addFilterRow() {
    ...
    html += '  <td class="text-right"><input type="text" name="filter[' + filter_row + '][ex]" value="" placeholder="<?php echo $entry_ex; ?>" id="input-sort-order2" class="form-control" /></td>';
