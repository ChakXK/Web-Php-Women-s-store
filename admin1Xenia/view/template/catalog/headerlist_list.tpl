            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
               ...
               <!-- <td class="text-center"><?php if (in_array($filter['filter_group_id'], $selected)) { ?>
                    ...
                    <?php } ?></td> -->
                  <td class="text-left"><?php echo $group_link['name']; ?></td>
                  <td class="text-right"><?php echo $group_link['group_link_id']; ?></td>
                  <td class="text-right"><a href="<?php echo $group_link['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php }} ?>
