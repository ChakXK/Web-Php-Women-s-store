...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
	  ...
	  $this->request->post['config_mail_regexp'] = trim($this->request->post['config_mail_regexp']);
		...
		$data['entry_decription'] = $this->language->get('entry_description');
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['config_description']) < 3) || (utf8_strlen($this->request->post['config_description']) > 32)) {
